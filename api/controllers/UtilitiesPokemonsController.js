...
module.exports = {
    ...
    isValidPokemonData: function (data, type) {
        if (sails.messages.CREATE === type) {
            return data.idUser && data.name && data.species && data.ability && data.color;
        } else if (sails.messages.CREATE_PUBLIC === type) {
            return data.name && data.species && data.ability && data.color;
        } else {
            return data.id && data.idUser && data.name && data.species && data.ability && data.color;
        }
    },
